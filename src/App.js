      ...
      <main className="flex flex-1 flex-col gap-20">
        ...
        >
          ...
          <header className="hidden items-center justify-between w-full max-w-[1260px] mx-auto px-[90px] pt-[50px] pb-6 sm:flex">
            ...
            {/* Smart-link to the proxy referral landing page — detects iOS/Android,
                deep-links into the app if installed, otherwise shows store buttons +
                grants the FREE15DAYS code's bonusTrialDays (15 by default). */}
            <a
              href="https://steadfast-blessing-production.up.railway.app/referral/free15days"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Download ProofPix — 15 days free trial"
              onClick={() => logDownloadAppClick({ location: "header", promo: "free15days" })}
              className="flex items-center transition hover:opacity-90"
              style={{ gap: "10px" }}
            >
              <span
                className="rounded-full bg-[#FFD700] text-black"
                style={{ padding: "9px 16px", fontSize: "13px", lineHeight: "16px", fontWeight: 700, letterSpacing: "-0.17px", whiteSpace: "nowrap" }}
              >
                15 days free trial
              </span>
              <span
                className="rounded-full bg-black font-semibold text-white"
                style={{ padding: "13px 26px", fontSize: "18px", lineHeight: "22px", fontWeight: "600", letterSpacing: "-0.17px" }}
              >
                Download App
              </span>
            </a>
          ...
          <div className="mx-auto hidden w-full flex-1 flex-col items-center text-center sm:flex">
            ...
            <h1 style={{ fontWeight: "600", fontSize: "52px", lineHeight: "63px", letterSpacing: "-0.201242px", width: "655px" }} className="mb-4 text-center text-proofpix-black">
              ...
              <span className="block">Professional Deliverables</span>
            </h1>

            <p style={{ fontWeight: "300", fontSize: "28px", lineHeight: "34px", letterSpacing: "-0.201242px", width: "655px" }} className="mb-2 text-center text-black">
              Capture, organize, document, and share every job with branded reports, cloud sync, and workflows built for service professionals.
            </p>

          </div>

          {/* Upload 2 Photos — try-it-now tool, embedded as part of the hero */}
          <UploadToolSection />
          </div>
        </section>
        ...
        <section className="mx-auto max-w-full px-4 py-12 lg:py-[100px] lg:px-[62px]">
          ...
          <div className="flex flex-col items-center" style={{ gap: "38.71px", marginBottom: "68px" }}>
            ...
            <p style={{ fontWeight: "300", fontSize: "27px", lineHeight: "130%", maxWidth: "1024px" }} className="hidden text-center text-[#2D2D2D] sm:block">
              Mobile-first capture, industry-specific workflows, and branded reporting — purpose-built for service businesses, not retrofitted from a consumer photo app.
            </p>
          </div>
          {/* Metric cards */}
